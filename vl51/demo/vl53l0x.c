...
VL53L0X_Dev_t vl53l0x_dev,vl53l0x_dev2,vl53l0x_dev3;//设备I2C数据参数
VL53L0X_DeviceInfo_t vl53l0x_dev_info,vl53l0x_dev_info2,vl53l0x_dev_info3;//设备ID版本信息
...
VL53L0X_Error vl53l0x_init(VL53L0X_Dev_t *dev)
{
	...
	printf("1\r\n");
	Status = vl53l0x_Addr_set(pMyDevice,0x52);//设置VL53L0X传感器I2C地址
...
VL53L0X_Error vl53l0x_init_2(VL53L0X_Dev_t *dev)
{
	GPIO_InitTypeDef  GPIO_InitStructure;
	VL53L0X_Error Status = VL53L0X_ERROR_NONE;
	VL53L0X_Dev_t *pMyDevice = dev;
	...
	printf("1\r\n");
	Status = vl53l0x_Addr_set(pMyDevice,0x58);//设置VL53L0X传感器I2C地址
...
VL53L0X_Error vl53l0x_init_3(VL53L0X_Dev_t *dev)
{
	GPIO_InitTypeDef  GPIO_InitStructure;
	VL53L0X_Error Status = VL53L0X_ERROR_NONE;
	VL53L0X_Dev_t *pMyDevice = dev;
	...
	VL53L0X_Xshut = 0;  //再失能第一个，使能第二个
	VL53L0X_Xshut_2 = 0;  //再失能第一个，使能第二个
	VL53L0X_Xshut_3 = 0;
	Delay_ms(30);
	VL53L0X_Xshut_3 = 1;
	Delay_ms(30);
	...
	printf("1\r\n");
	Status = vl53l0x_Addr_set(pMyDevice,0x62);//设置VL53L0X传感器I2C地址
...
void vl53l0x_info2(void)
{
	printf("\r\n-------vl53l0x传感器设备信息-------\r\n\r\n");
	printf("  Name:%s\r\n",vl53l0x_dev_info2.Name);
	printf("  Addr:0x%x\r\n",vl53l0x_dev2.I2cDevAddr);
	printf("  ProductId:%s\r\n",vl53l0x_dev_info2.ProductId);
	printf("  RevisionMajor:0x%x\r\n",vl53l0x_dev_info2.ProductRevisionMajor);
	printf("  RevisionMinor:0x%x\r\n",vl53l0x_dev_info2.ProductRevisionMinor);
	printf("\r\n-----------------------------------\r\n");
}
void vl53l0x_info3(void)
{
	printf("\r\n-------vl53l0x传感器设备信息-------\r\n\r\n");
	printf("  Name:%s\r\n",vl53l0x_dev_info3.Name);
	printf("  Addr:0x%x\r\n",vl53l0x_dev3.I2cDevAddr);
	printf("  ProductId:%s\r\n",vl53l0x_dev_info3.ProductId);
	printf("  RevisionMajor:0x%x\r\n",vl53l0x_dev_info3.ProductRevisionMajor);
	printf("  RevisionMinor:0x%x\r\n",vl53l0x_dev_info3.ProductRevisionMinor);
	printf("\r\n-----------------------------------\r\n");
}
...
void One_measurement2(u8 mode)
{
	vl53l0x_set_mode(&vl53l0x_dev2,mode);
	VL53L0X_PerformSingleRangingMeasurement(&vl53l0x_dev2,&vl53l0x_data2);
	printf("\r\n d2: %4d mm.\r\n",vl53l0x_data2.RangeMilliMeter);
		
}


void One_measurement3(u8 mode)
{
	vl53l0x_set_mode(&vl53l0x_dev3,mode);
	VL53L0X_PerformSingleRangingMeasurement(&vl53l0x_dev3,&vl53l0x_data3);
	printf("\r\n d: %4d mm.\r\n",vl53l0x_data3.RangeMilliMeter);
