...
#define VL53L0X_Xshut_2 PBout(5)
#define VL53L0X_Xshut_3 PBout(6)
...
VL53L0X_Error vl53l0x_init_2(VL53L0X_Dev_t *dev);//初始化第二个vl53l0x
VL53L0X_Error vl53l0x_init_3(VL53L0X_Dev_t *dev);//初始化第三个vl53l0x
...
void vl53l0x_info2(void);//获取vl53l0x设备ID信息
void vl53l0x_info3(void);//获取vl53l0x设备ID信息
void One_measurement(u8 mode);//获取一次测量距离数据
void One_measurement2(u8 mode);
void One_measurement3(u8 mode); 
//int test_distance(u8 i);
#endif
